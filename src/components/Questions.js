            ...
            <Accordion className="py-3" activeKey={activeKey} onSelect={handleAccordionToggle}>
                <Accordion.Item id="questions-session-description" eventKey="0">
                    ...
                    <Accordion.Body>
                        ...
                        <p>Mon objectif est de vous aider à atteindre les vôtres, que ce soit pour surmonter des habitudes indésirables, gérer le stress, ou améliorer divers aspects de votre vie. La confiance et le respect mutuel sont au cœur de notre collaboration, et je suis là pour vous guider tout au long du processus.</p>
                    </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item id="questions-session-duration" eventKey="1">
                    ...
                    <Accordion.Body>
                        <p>La durée d'une séance d'hypnose peut varier en fonction des besoins spécifiques de chaque individu. En général, une séance dure 60 minutes et peut être ajustée en fonction des personnes.</p>
                ...
                <Accordion.Item id="questions-session-number" eventKey="2">
                    ...
                    <Accordion.Body>
                        <p>Dans certains cas, des résultats significatifs peuvent être obtenus en une séance, tandis que d'autres situations peuvent nécessiter un suivi plus régulier sur une période prolongée. Mon approche est centrée sur vos besoins individuels, et je recommande un plan de traitement personnalisé en fonction de notre évaluation initiale.</p>
                ...
                <Accordion.Item id="questions-why-erickson" eventKey="3">
                    ...
                    <Accordion.Body>
                        ...
                        <p>Enfin, l'hypnose ericksonienne favorise la collaboration active entre le praticien et le client. Vous n'êtes pas un simple observateur, mais un participant actif dans le processus de changement. Cela renforce l'autonomie, contribuant ainsi à des transformations plus profondes et significatives.</p>
                    </Accordion.Body>
                </Accordion.Item>
            </Accordion>
